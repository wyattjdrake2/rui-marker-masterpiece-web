        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-gray-400">insonibusiness@gmail.com</span>
            </div>
      ...
      <Dialog open={isPrivacyOpen} onOpenChange={setIsPrivacyOpen}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="mt-4 space-y-4">
            ...
            <p>If you are located in the EU, you have the right to access, correct, or delete your personal data. Please contact us at insonibusiness@gmail.com for any requests.</p>
            ...
            <p className="mt-6">For questions, contact us at insonibusiness@gmail.com.</p>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isTermsOpen} onOpenChange={setIsTermsOpen}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="mt-4 space-y-4">
            ...
            <p className="mt-6">If you have questions, please contact us at insonibusiness@gmail.com.</p>
          </div>
        </DialogContent>
      </Dialog>
    </footer>
